...
function formatEntryData(mixed $entry, int $counter): void
{
  ...
  if (rgar($entry, '75') != '') {
    echo '<b>' . rgar($entry, '75') . '</b>';
  }
  echo  '</td>';

  echo  '<td>';
  /**
   * Define the range of checkbox IDs based on your form configuration. For type of fishing you enjoy
   */
  $checkbox_ids = ['290.1', '290.2', '290.3', '290.4', '290.5', '290.6']; // Add as many as needed, or determine dynamically based on your specific form setup.
  ...
  echo  '<td>';
  // If you are bringing your own fishing equipment, please specify single or two handed and what weight rods.
  if (rgar($entry, '293') != '') {
